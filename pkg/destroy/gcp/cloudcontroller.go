...
func (o *ClusterUninstaller) listCloudControllerBackendServices(ctx context.Context, instanceGroups []cloudResource) ([]cloudResource, error) {
	...
	return o.listBackendServicesWithFilter(ctx, "regionBackendService", "items(name,backends),nextPageToken", filter, o.regionBackendServiceList)
}
...
func (o *ClusterUninstaller) discoverCloudControllerLoadBalancerResources(ctx context.Context, loadBalancerName string) error {
	...
	found, err := o.listAddressesWithFilter(ctx, "regionaddress", "items(name),nextPageToken", loadBalancerNameFilter, o.addressList)
	if err != nil {
		return err
	}
	...
	found, err = o.listTargetTCPProxiesWithFilter(ctx, "targettcpproxy", "items(name),nextPageToken", loadBalancerNameFilter, o.targetTCPProxyList)
	if err != nil {
		return err
	}
	o.insertPendingItems("targettcpproxy", found)

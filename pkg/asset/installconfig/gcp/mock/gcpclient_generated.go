...
func (m *MockAPI) GetImage(ctx context.Context, project, name string) (*compute.Image, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetImage", ctx, project, name)
...
func (mr *MockAPIMockRecorder) GetImage(ctx, project, name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetImage", reflect.TypeOf((*MockAPI)(nil).GetImage), ctx, project, name)
}
